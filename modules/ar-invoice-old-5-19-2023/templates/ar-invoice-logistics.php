...
<div style="padding-top:10px;">
	<div class="row" style="padding-bottom:10px;">
		<div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
			...
			<div class="input-group ">
					...
					<select id="selShipToAddress" class="col-sm-12 form-control mdb-select md-form text-left"  style=" outline:none; border-color: #D0D0D0;">
					</select>
				</div>
		</div>
	...
	<div class="row">
		<div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
			...
			<div class="input-group ">
					...
					<select id="selBillToAddress" class="col-sm-12 form-control mdb-select md-form text-left"  style=" outline:none; border-color: #D0D0D0;">
					</select>
				</div>
		</div>
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
	...
	<div class="row">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 py-2">
								 <select id="selShippingType" class="col-sm-12 form-control mdb-select md-form text-left"  style="outline:none; border-color: #D0D0D0;">
