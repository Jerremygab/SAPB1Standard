...
<?php
	...
	$_SESSION['baseTableName1'] = $APInvoiceArr['baseTableName1'];
	$_SESSION['copyFromModal1'] = $APInvoiceArr['copyFromModal1'];
	$_SESSION['copyFromModalTbl1'] = $APInvoiceArr['copyFromModalTbl1'];
?>
