...
<?php
	$ARInvoiceArr = array(
		...
		"childTable12" => "INV12",
		"childTable21" => "INV21",
		"baseTableName1" => "Delivery",
		"baseTable1" => "ODLN",
		"base1ChildTable1" => "DLN1",
		"baseType1" => 15,
		"copyFromModal1" => 'delivery',
		"copyFromModalTbl1" => 'DR'
	);
	...
	$_SESSION['baseTableName1'] = $ARInvoiceArr['baseTableName1'];
	$_SESSION['copyFromModal1'] = $ARInvoiceArr['copyFromModal1'];
	$_SESSION['copyFromModalTbl1'] = $ARInvoiceArr['copyFromModalTbl1'];
?>
	...
	<script type="text/javascript">
		...
		sessionStorage.setItem('baseTableName1', obj.baseTableName1);
		sessionStorage.setItem('baseTable1', obj.baseTable1);
		sessionStorage.setItem('baseType1', obj.baseType1);
		sessionStorage.setItem('copyFromModal1', obj.copyFromModal1);
		sessionStorage.setItem('copyFromModalTbl1', obj.copyFromModalTbl1);
	</script>	
...
<div class="tab-content" id="myTabContent" style="padding-top: 10px;">
	...
	<div class="form-group row  mb-0" >
		...
		<label for="inputEmail3" class="col-sm-4 col-form-label pr-0" style="color: black; font-size:15px" >Item/Service Type</label>
			<select id="selTransactionType" class="col-sm-3 form-control-sm mdb-select md-form text-left" searchable="Search here.." style="outline:none; border-color: #D0D0D0;">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 text-right">
								...
								<button type="button" id="btnCopyFrom" disabled="disabled" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle  btn btn-warning btn-rounded dropdown-toggle" style="color: black; font-weight: bold; width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);" >Copy From</button>			
								  <ul class="dropdown-menu " aria-labelledby="btnCopyFrom" style="color: black; font-weight: bold; width:250px; background-color: #fdfd96;">
									<li><button type="button" id="btnCopyFrom<?php echo $_SESSION['copyFromModalTbl1'];?>" class="dropdown-item" style="color: black; font-weight: bold; font-size:15px;" data-toggle="modal" data-target="#<?php echo $_SESSION['copyFromModal1'];?>Modal" data-backdrop="false"><?php echo $_SESSION['baseTableName1']; ?></button></li>
								  </ul>
								</span>
					</div>
...
<!-- Logout Modal-->
  ...
  <!-- Document Modal -->
    ...
    <div class="modal fade" id="<?php echo $_SESSION['copyFromModal1'];?>Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
      <div class="modal-dialog modal-xl" role="document" style="width:100%">
        <!--Content-->
        <div class="modal-content-full-width modal-content">
          <!--Header-->
          <div class="modal-header"  style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
            <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of <?php echo $_SESSION['baseTableName1']; ?></h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <!--Body-->
			 <div class="modal-body">
				<div id="<?php echo $_SESSION['copyFromModal1'];?>Result"></div>
			</div>
          <!--Footer-->
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
  ...
  <!-- Business Partner Modal -->
   ...
   <!-- Item Code Modal -->
    ...
    <div class="modal fade" id="refDocModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document" style="width:100%; ">
        <!--Content-->
        <div class="modal-content-full-width modal-content" style="height: 500px; width: 1100px;">
          <!--Header-->
          <div class="modal-header"  style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
