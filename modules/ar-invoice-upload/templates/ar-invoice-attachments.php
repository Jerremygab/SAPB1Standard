...
<div class="">
<table id="tblAttachment" class="table table-striped table-bordered table-sm detailsTable col-md-6" cellspacing="0"  style="background-color: white; overflow-x:scroll; width : 100%;" cellspacing="0">
